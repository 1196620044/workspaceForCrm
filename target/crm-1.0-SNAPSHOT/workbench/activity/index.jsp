...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		*/
		...
		//为更新按钮绑定事件，执行市场活动的修改工作
		/**
			在实际项目开发中，一定是先做添加，再做修改操作
		 	为了节省开发时间，修改操作一般都是copy的添加操作
		 */
							...
							<div class="col-sm-10" style="width: 81%;">
								...
								<%--
									...
									关于文本域textarea
										...
										（2）在textarea虽然是以标签对形式出现，但是它属于表单元素范畴
											所有textarea的取值和赋值操作，应该统一使用val()方法，（而不是使用html()方法）
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
					<%--
						...
						data-target="#createActivityModal"：表示将要打开哪个模态窗口，通过 #id的形式打开该窗口

						现在我们是以属性和属性值的方式写在了button元素中，用来打开模态窗口
						   无法对按钮的功能进行扩充

						所以未来实际开发中，对于模态窗口的操作，不要写死在元素中
						应该写在js代码中来操作
